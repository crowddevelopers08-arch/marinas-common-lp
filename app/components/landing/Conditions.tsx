...
export function Conditions({ onPick }: { onPick: (condition: string) => void }) {
  return (
    <section className={cx(section, "overflow-hidden")} id="conditions">
      <div className={wrap}>
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p className={cx(lead, "mx-auto")}>Tap a condition to prefill the consultation form and get to the right conversation faster.</p>
        </div>
        {/* Desktop grid */}
